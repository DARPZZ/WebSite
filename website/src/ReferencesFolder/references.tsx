...
function References() {
  return (
    <div className="w-full h-full flex flex-col justify-center">
      <h1 className="text-5xl 4xl:text-8xl justify-center items-center flex mb-5 md:items-baseline font-extrabold text-green-400 font-inter">
        References
      </h1>
      <div className="flex justify-center flex-col w-full items-center font-manrope  text-wrap text-lg text-white">
